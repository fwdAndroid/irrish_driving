...
import 'package:irrish_driving/screens/status/phonestatus/checkphonestatus.dart';
                    ...
                    await FirebaseAuth.instance
                      ...
                      if (value.user != null) {
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (ctx) => const CheckPhoneStatus()));
                      }
                    });
                  } catch (e) {
        ...
        verificationCompleted: (PhoneAuthCredential credential) async {
          await FirebaseAuth.instance
            ...
            if (value.user != null) {
              Navigator.of(context).push(
                MaterialPageRoute(
                  builder: (builder) => const CheckPhoneStatus(),
                ),
              );
